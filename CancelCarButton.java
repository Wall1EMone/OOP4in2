    ...
    public void cancelCar(){
        ...
        cancelButton.setOnAction(e ->{
            ...
            cancelInfo.setText(nameInput.getText() +", " +
                    lastnameInput.getText() + ", " + mailInput.getText() + " har avslutat bokning på " +  carNameInput.getText() + ". Tack och välkommen åter!");
        });


        grid.getChildren().addAll(nameLabel, nameInput, lastName, lastnameInput, carName, carNameInput,
